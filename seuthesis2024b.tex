\documentclass[degree = b, fontset = mac ms]{seuthesis2024} % 使用 macOS 上的 MS Word 字体
% \documentclass[degree = b]{seuthesis2024} % 使用 fonts 文件夹字体
% \documentclass[degree = b, twoside]{seuthesis2024} % 使用双页模式
...
\begin{document}
  ...
  \input{chapters_b/introduction}
    
  \chapter{正文}\label{chap:body}
  \input{chapters_b/body}
  ...
  % 致谢
  \chapterAck
  \input{chapters_b/acknowledgment}
